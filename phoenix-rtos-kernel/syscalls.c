...
void syscalls_getPHC(void* ustack){
	int *procHeight, *procCount;
	GETFROMSTACK(ustack, int *, procHeight, 0);
	GETFROMSTACK(ustack, int *, procCount, 1);
	posix_getProcHeightCount(&procHeight, &procCount);
	//*procHeight = 400;
	//*procCount = 200;
